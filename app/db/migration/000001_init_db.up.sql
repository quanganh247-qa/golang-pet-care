...
CREATE TABLE pet_schedule (
    ...
    schedule_type VARCHAR(20) NOT NULL, -- e.g., 'Feeding', 'Activity'
    event_time TIMESTAMP NOT NULL, -- Time of the activity or feeding
    duration INTERVAL, -- Duration for activities (optional for feeding)
    food_type VARCHAR(100), -- Type of food for feeding (optional for activity)
    quantity FLOAT8, -- Quantity for feeding (optional for activity)
    activity_type VARCHAR(50), -- Type of activity (optional for feeding)
    frequency VARCHAR(50), -- Frequency of the event (e.g., 'Daily', 'Weekly')
    notes TEXT,
