...
ALTER TABLE "Appointment" ADD FOREIGN KEY ("ServiceID") REFERENCES "Service" ("ServiceID") ON DELETE CASCADE;

ALTER TABLE "Checkout_Service" ADD FOREIGN KEY ("CheckoutID") REFERENCES "Checkout" ("CheckoutID") ON DELETE CASCADE;

ALTER TABLE "Checkout" ADD FOREIGN KEY ("PetID") REFERENCES "Pet" ("PetID") ON DELETE CASCADE;

ALTER TABLE "Checkout_Service" ADD FOREIGN KEY ("ServiceID") REFERENCES "Service" ("ServiceID") ON DELETE CASCADE;
