...
type ServiceServiceInterface interface {
	...
	getAllServicesService(ctx *gin.Context, limit, offset int32) ([]db.Service, error)
...
func (server *ServiceService) createServiceService(ctx *gin.Context, req createServiceRequest) (*db.Service, error) {
	...
	// fmt.Println("req.TypeID", req.Name)
...
func (server *ServiceService) getAllServicesService(ctx *gin.Context, limit, offset int32) ([]db.Service, error) {
